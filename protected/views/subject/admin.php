			...
			'columns'=>array(
				...
				array(
					...
					(
						'view' => array
						(
							'url'=>'Yii::app()->createUrl("Subject/View", array("id"=>$data->ID))',
						...
						'update' => array
						(
							'url'=>'Yii::app()->createUrl("Subject/Update", array("id"=>$data->ID))',
						...
						'delete' => array
						(
							'url'=>'Yii::app()->createUrl("Subject/Delete", array("id"=>$data->ID))',
