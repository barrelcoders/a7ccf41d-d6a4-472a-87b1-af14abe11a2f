			...
			'columns'=>array(
				...
				array(
					...
					(
						'view' => array
						(
							'url'=>'Yii::app()->createUrl("Student/View", array("id"=>$data->ID))',
						...
						'update' => array
						(
							'url'=>'Yii::app()->createUrl("Student/Update", array("id"=>$data->ID))',
						...
						'delete' => array
						(
							'url'=>'Yii::app()->createUrl("Student/Delete", array("id"=>$data->ID))',
